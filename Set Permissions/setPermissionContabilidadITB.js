...
function setPermission() {
		...
		var def =
		  {
		     query: "TYPE:'cm:folder' AND PATH:'/app:company_home/st:sites/cm:area-administrativa-itb/cm:documentLibrary/cm:Contabilidad/*'",
		...
		nod.setPermission("SiteConsumer", "GROUP_GRUPO_CONTABILIDAD");
