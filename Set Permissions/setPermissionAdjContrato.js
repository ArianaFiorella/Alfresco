...
function setPermission() {
		...
		var def =
		  {
		     query: "TYPE:'cm:folder' AND cm:name:'CONTRATO' AND cm:description:'CONTRATO' AND PATH:'/app:company_home/st:sites/cm:itbussiness/cm:documentLibrary/cm:PROYECTOS//*'",
