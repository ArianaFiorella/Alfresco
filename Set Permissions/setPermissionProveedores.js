...
function setPermission() {
		...
		var def =
		  {
		     query: "TYPE:'cm:folder' AND cm:name:'PROVEEDORES' AND cm:description:'PROVEEDORES' AND PATH:'/app:company_home/st:sites/cm:itbussiness/cm:documentLibrary/cm:PROYECTOS//*'",
